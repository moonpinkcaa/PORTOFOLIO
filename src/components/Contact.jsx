    ...
    <section id="contact" className="relative py-24 overflow-hidden"
      ...
      <div className="w-full max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="reveal flex justify-center py-8">
          ...
          >
            {/* Inner Dark Red Card (matching Hero box field) */}
            <div
            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                {/* Title */}
                <h2 className="font-display font-black tracking-tight text-3xl md:text-5xl uppercase mb-8 text-white"
                  style={{
                    lineHeight: '1.1',
                ...
                <a
                  ...
                  className="font-display font-medium text-xs md:text-sm tracking-wider hover:underline transition-colors duration-200"
